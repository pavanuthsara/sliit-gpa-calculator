      ...
      <div>
        ...
        {syllabus === "NEW" && (
          <p className="mt-2 text-xs text-amber-400/80 flex items-center gap-1.5">
            ...
            New Syllabus was started in 2024 June.
            {/* <code className="font-mono text-amber-300">curriculum.js</code> when ready. */}
          </p>
        )}
      </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        <div className="flex-1">
          ...
          <p className="text-xs text-slate-500">
            Select your programme to load the correct modules
          </p>
        </div>
